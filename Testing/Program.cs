...
namespace Testing
{
    class Program
    {
        static readonly string _assetsPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "assets");
        ...
        static void Main(string[] args)
        {
            ...
            // Load trained model
            // ITransformer model = mlContext.Model.Load("trained_model.zip", out modelSchema);

            ITransformer model = LoadModel(mlContext, Path.Combine("1563186361", "saved_model.pb"));
        ...
        public static void ClassifyImages(MLContext mlContext, string dataLocation, string imagesFolder, string outputModelLocation, ITransformer model)
        {
            ...
            var scoreData = model.Transform(imageDataView);
