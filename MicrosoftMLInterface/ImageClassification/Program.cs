...
namespace ImageClassification
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var inceptionPb = Path.Combine(assetsPath, "inputs", "mobileNetV2", "saved_model.pb");
            var labelsTxt = Path.Combine(assetsPath, "inputs", "mobileNetV2", "imagenet_comp_graph_label_strings.txt");
